...
Процедура ПечатьЧекаНаСервере(ТабДок)
	...
	Для Каждого СтрокаРаботы Из Объект.Работы Цикл
    	...
    	Таблица.Параметры.Сумма = СтрокаРаботы.НормаЧас *  СтоимостьНормаЧаса.Стоимость;
    	СуммаПоРаботам = СуммаПоРаботам + СтрокаРаботы.НормаЧас *  СтоимостьНормаЧаса.Стоимость;
